# Multi-Purpose Brain-Computer Interface (current setup for Minecraft)
...
N.B. This is for an OpenBCI Setup (Tested on Mac M1 but not on windows or linux) & Output commands are easily alterable for any purpose
---
